...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '为学之道，先博后约，猛火煮，慢火温，必有所得🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '礁岩蛋白', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '盖学无边，而亦乐分享，博学之路，欣然相知', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '420555468@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  // 动态彩带特效
  FLUTTERINGRIBBON: process.env.NEXT_PUBLIC_FLUTTERINGRIBBON || flase, // 开关
  // 静态彩带特效
  RIBBON: process.env.NEXT_PUBLIC_RIBBON || flase, // 开关
  // 星空雨特效 黑夜模式才会生效
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由owenhao的NotionNext生成的站点', // 站点描述，被notion中的页面描述覆盖
